...
import com.Infinity.Nexus.Generators.block.entity.GasPoweredGeneratorBlockEntity;
...
public class GasPoweredGeneratorMenu extends AbstractContainerMenu {
    public final GasPoweredGeneratorBlockEntity blockEntity;
    private final Level level;
    private final ContainerData data;


    public GasPoweredGeneratorMenu(int pContainerId, Inventory inv, FriendlyByteBuf extraData) {
        this(pContainerId, inv, inv.player.level().getBlockEntity(extraData.readBlockPos()), new SimpleContainerData(2));
    }

    public GasPoweredGeneratorMenu(int pContainerId, Inventory inv, BlockEntity entity, ContainerData data) {
        super(ModMenuTypes.GAS_POWERED_GENERATOR_MENU.get(), pContainerId);
        checkContainerSize(inv,TE_INVENTORY_SLOT_COUNT);
        blockEntity = ((GasPoweredGeneratorBlockEntity) entity);
    ...
    public GasPoweredGeneratorBlockEntity getBlockEntity(){
        return blockEntity;
    }
    ...
    public boolean stillValid(Player player) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                player, ModBlocks.GASOLINE_POWERED_GENERATOR.get());
    }
